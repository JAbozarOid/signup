package com.sample.auth.adapter
...
class TodoAdapter internal constructor(
    context: Context?,
    private val mData: List<TodoResultModel>
) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = mInflater.inflate(R.layout.todo_row, parent, false)
